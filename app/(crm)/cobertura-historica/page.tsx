...
export default function ClientesPage() {
  ...
  useEffect(() => {
    ...
    fetch(`/api/ventas?modo=clientes`)
      .then((res) => res.json())
      .then(setData)
      .catch(console.error);

    fetch(`/api/ventas?modo=stickiness`)
      .then((res) => res.json())
      .then(setStickinessData)
      .catch(console.error);

    fetch(`/api/ventas?modo=retencion_tam`)
      .then((res) => res.json())
      .then(setRetencionTAM)
      .catch(console.error);  
